...
class Environment:
    ...
    def save_data(self):
        np.savetxt('/home/prolee/apps/UAV_Obstacle_Avoiding_DRL-master/Dynamic_obstacle_avoidance/multi_csv/start_sac.csv', self.start, delimiter=',')
        np.savetxt('/home/prolee/apps/UAV_Obstacle_Avoiding_DRL-master/Dynamic_obstacle_avoidance/multi_csv/goal_sac.csv', self.goal, delimiter=',')
        np.savetxt('/home/prolee/apps/UAV_Obstacle_Avoiding_DRL-master/Dynamic_obstacle_avoidance/multi_csv/obs_r_list_sac.csv',self.obs_r,delimiter=',')
        for i in range(self.obs_num):
            np.savetxt('/home/prolee/apps/UAV_Obstacle_Avoiding_DRL-master/Dynamic_obstacle_avoidance/multi_csv/obs{}_trace_sac.csv'.format(i),self.path[i],delimiter=',')
...
if __name__ == "__main__":
    ...
    # save trace
    np.savetxt('/home/prolee/apps/UAV_Obstacle_Avoiding_DRL-master/Dynamic_obstacle_avoidance/multi_csv/multipathMatrix_sac.csv',uav_path,delimiter=',')
    env.save_data()
    np.savetxt('/home/prolee/apps/UAV_Obstacle_Avoiding_DRL-master/Dynamic_obstacle_avoidance/multi_csv/reward_sac.csv',reward_stack,delimiter=',')
    # # save action trace
    ...
    np.savetxt('/home/prolee/apps/UAV_Obstacle_Avoiding_DRL-master/Dynamic_obstacle_avoidance/multi_csv/d_list_{}_sac.csv'.format(if_test_origin_ifds),d_list,delimiter=',')
    plt.show()
