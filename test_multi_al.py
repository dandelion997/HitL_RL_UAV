...
class Environment:
    ...
    def save_data(self):
        np.savetxt('/home/prolee/apps/UAV_Obstacle_Avoiding_DRL-master/Dynamic_obstacle_avoidance/multi_csv/start_al.csv', self.start, delimiter=',')
        np.savetxt('/home/prolee/apps/UAV_Obstacle_Avoiding_DRL-master/Dynamic_obstacle_avoidance/multi_csv/goal_al.csv', self.goal, delimiter=',')
        np.savetxt('/home/prolee/apps/UAV_Obstacle_Avoiding_DRL-master/Dynamic_obstacle_avoidance/multi_csv/obs_r_list_al.csv',self.obs_r,delimiter=',')
        for i in range(self.obs_num):
            np.savetxt('/home/prolee/apps/UAV_Obstacle_Avoiding_DRL-master/Dynamic_obstacle_avoidance/multi_csv/obs{}_trace_al.csv'.format(i),self.path[i],delimiter=',')
    ...
    def load_Q(method):
        ...
        Q_network = torch.load('/home/prolee/apps/UAV_Obstacle_Avoiding_DRL-master/Dynamic_obstacle_avoidance/IIFDS-{}-random_start/TrainedModel/dynamicCritic_h.pkl'.format(method), map_location=device)
        return Q_network
...
if __name__ == "__main__":
    ...
    # save trace
    np.savetxt('/home/prolee/apps/UAV_Obstacle_Avoiding_DRL-master/Dynamic_obstacle_avoidance/multi_csv/multipathMatrix_al.csv',uav_path,delimiter=',')
    env.save_data()
    np.savetxt('/home/prolee/apps/UAV_Obstacle_Avoiding_DRL-master/Dynamic_obstacle_avoidance/multi_csv/reward_al.csv',reward_stack,delimiter=',')
    ...
    #np.savetxt('/home/prolee/apps/UAV_Obstacle_Avoiding_DRL-master/Dynamic_obstacle_avoidance/multi_csv/omega_al.csv', omega_stack, delimiter=',')
    
    # # save distance between UAV and Obstacle
    np.savetxt('/home/prolee/apps/UAV_Obstacle_Avoiding_DRL-master/Dynamic_obstacle_avoidance/multi_csv/d_list_{}_al.csv'.format(if_test_origin_ifds),d_list,delimiter=',')
    plt.show()
