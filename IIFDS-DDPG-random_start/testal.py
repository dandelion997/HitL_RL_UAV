...
if __name__ == "__main__":
    ...
    # np.savetxt('/home/prolee/apps/UAV_Obstacle_Avoiding_DRL-master/Dynamic_obstacle_avoidance/IIFDS-DDPG-random_start/env2_csv/pathMatrix_our2.csv', path, delimiter=',')
    # np.savetxt('/home/prolee/apps/UAV_Obstacle_Avoiding_DRL-master/Dynamic_obstacle_avoidance/IIFDS-DDPG-random_start/env2_csv/reward_our2.csv', reward_stack, delimiter=',')
    # np.savetxt('/home/prolee/apps/UAV_Obstacle_Avoiding_DRL-master/Dynamic_obstacle_avoidance/IIFDS-DDPG-random_start/env2_csv/theta_our2.csv', theta_stack, delimiter=',')
    # np.savetxt('/home/prolee/apps/UAV_Obstacle_Avoiding_DRL-master/Dynamic_obstacle_avoidance/IIFDS-DDPG-random_start/env2_csv/omega_al.csv', omega_stack, delimiter=',')
